...
# Stock Trading Knowledge Vault Index

Read this page first when answering questions or ingesting sources. Update it whenever durable wiki pages are added or materially changed.

## Core Pages

- [Overview](overview.md) - High-level map of the trading knowledge vault.
- [Glossary](glossary.md) - Short definitions for trading terms used across the wiki.
- [Open Questions](questions/open-questions.md) - Research backlog and unresolved investigations.
- [Log](log.md) - Chronological append-only history of vault activity.

## Source Notes

- [Source Notes](source-notes/README.md) - One synthesized note per ingested raw source.
...
- [Technical Analysis For Dummies 4th Ed — Barbara Rockefeller](source-notes/2026-06-24-technical-analysis-for-dummies.md) — 2020 comprehensive TA textbook: indicators, patterns, candlesticks, moving averages, MACD, Bollinger Bands, ATR, Stochastic, Ichimoku, P&F.

## Entities

- [Companies](entities/companies/README.md) - Public companies and ticker-centered research pages.
- [People](entities/people/README.md) - Investors, executives, researchers, authors, and traders.
- [Institutions](entities/institutions/README.md) - Funds, exchanges, regulators, data providers, and research firms.
- [Jesse L. Livermore](entities/people/jesse-livermore.md) - Trader and author of `How to Trade in Stocks`.
- [Mark Minervini](entities/people/mark-minervini.md) - Trader, author, U.S. Investing Champion 1997, creator of SEPA® strategy.
- [Barbara Rockefeller](entities/people/barbara-rockefeller.md) — Author of Technical Analysis For Dummies 4th Ed (2020).

## Research Topics

- [Concepts](concepts/README.md) - Market mechanics, risk, psychology, valuation, catalysts, and other concepts.
- [Strategies](strategies/README.md) - Strategy hypotheses, rules, evidence, regimes, and failure modes.
- [Indicators](indicators/README.md) - Technical, fundamental, sentiment, macro, and quantitative indicators.
- [Setups](setups/README.md) - Actionable trade setup checklists and decision criteria.
- [Sectors](sectors/README.md) - Sector and industry research.
- [Instruments](instruments/README.md) - Stocks, ETFs, options, futures, bonds, crypto, and derivatives.
- [Market Leadership](concepts/market-leadership.md) - How leading groups emerge, confirm moves, and rotate.
- [Pivotal Point Trading](strategies/pivotal-point-trading.md) - Livermore-style entry and exit strategy around pivotal points.
- [Livermore Market Key](indicators/livermore-market-key.md) - Manual trend and pivotal-point record system.
- [RSI](indicators/rsi.md) - Relative Strength Index: momentum oscillator, overbought/oversold levels, divergence signals.
- [Breakout After Normal Reaction](setups/breakout-after-normal-reaction.md) - Setup based on recovery from orderly pullbacks.
- [Ascending Triangle Breakout](setups/ascending-triangle-breakout.md) - Flat-resistance breakout with volume confirmation and RSI filter.
- [Support and Resistance](concepts/support-resistance.md) - Price floors/ceilings and role-reversal dynamics after breakouts.
- [Stage Analysis](concepts/stage-analysis.md) - Four-stage stock price lifecycle: Neglect, Advancing, Topping, Declining.
- [Trend Template](concepts/trend-template.md) - Minervini's 8-criterion filter for confirming Stage 2 uptrends before entry.
- [Volatility Contraction Pattern (VCP)](setups/volatility-contraction-pattern.md) - Progressively tighter pullbacks with contracting volume forming a precise entry point.
- [Relative Strength Ranking](indicators/relative-strength-ranking.md) - IBD RS Rating: stock's 12-month return vs. all other stocks, expressed 1–99. Distinct from the RSI oscillator.
...
- [Moving Averages](indicators/moving-averages.md) — SMA, EMA, dual/triple crossover systems, ribbon, convergence/divergence.
- [MACD](indicators/macd.md) — Moving Average Convergence Divergence: 12/26 EMA, 9-day signal line, histogram, divergence signals.
- [Bollinger Bands](indicators/bollinger-bands.md) — Volatility bands at ±2 std dev from 20-day SMA; squeeze signals impending breakout.
- [Average True Range (ATR)](indicators/average-true-range.md) — True range volatility indicator; used for stop sizing and orderliness assessment.
- [Stochastic Oscillator](indicators/stochastic-oscillator.md) — %K/%D momentum oscillator using H, L, C; overbought/oversold and divergence signals.
- [TA4D Pivot Points](indicators/ta4d-pivot-points.md) — Mathematical PP=(H+L+C)/3 formula with R1-R3/S1-S3 zones; day-trading S/R. Distinct from Livermore's Pivotal Point.
- [Dow Theory](concepts/dow-theory.md) — Foundational TA: prices trend, primary trends, secondary retracements, persistence until disrupted.
- [Price Bars](concepts/price-bars.md) — OHLC bar construction, bar scoring, special bars, gaps taxonomy (breakaway/runaway/exhaustion/island).
- [Candlestick Charting](concepts/candlestick-charting.md) — Japanese candlestick anatomy, doji types, shaven bars, multi-bar emotional patterns.
- [Chart Patterns](concepts/chart-patterns.md) — Continuation patterns (triangles, flags) and reversal patterns (H&S, double top/bottom); measured moves.
- [Trendlines and Channels](concepts/trendlines-channels.md) — Rule-based trendlines, regression channels, breakout authentication, orderliness, blowout tops.
- [Volume Analysis](concepts/volume-analysis.md) — OBV, volume divergence, volume spikes, volume-price confirmation rules.
- [Ichimoku](concepts/ichimoku.md) — Hosoda's five-component system: tenkan/kijun, senkou spans, chikou, kumo cloud.
- [Point and Figure](concepts/point-and-figure.md) — X/O chart format filtering time/noise; vertical and horizontal price projections.
...
- [2026-08-10 BAJAJHLDNG, BANDHANBANK, and CDSL Deep 1-Year VCP/Livermore/SEPA Scan](trade-journal/analysis/2026-08/2026-08-10-bajajhldng-bandhanbank-cdsl-deep-1y-vcp-livermore-sepa-scan.md) - BAJAJHLDNG is a Setup with a tight VCP and bullish Livermore signal; BANDHANBANK and CDSL remain Watchlist.
- [2026-08-10 Large-Cap, Financials, and Defensives Deep 1-Year VCP/Livermore/SEPA Scan](trade-journal/analysis/2026-08/2026-08-10-largecap-financials-deep-1y-vcp-livermore-sepa-scan.md) - Seven requested symbols; no mechanical setups. NAM-INDIA is closest but remains Watchlist; TCS, INFY, ITC, HDFCBANK, and HDFCAMC are Avoid.
...
- [2026-07-03 ETF Swing Deep Analysis — VCP/Pivotal Points (23 symbols)](trade-journal/analysis/2026-07/2026-07-03-etf-swing-deep-analysis-23-symbols.md) — Full VCP, Livermore pivotal-point, and SEPA analysis on all 22 available ETFs. MONQ50 top pick (8/8 TT, 3-contraction VCP, new 52w high breakout); MOALPHA50/MOSMALL250/JUNIORBEES best R:R pullback setups. Gold/silver Stage 3 avoids. US-linked ETFs in healthy correction.
- [2026-07-03 ETF Swing Scan — 23 Symbols](trade-journal/analysis/2026-07/2026-07-03-etf-swing-scan-23-symbols.md) — NIFTYBEES, BANKBEES, ICICIB22, CPSEETF, HDFCGOLD, SETFGOLD, SBISILVER, NIFTYIETF, NEXT50IETF, MIDCAPETF, HDFCSML250, MOSMALL250, HDFCMOMENT, MOMENTUM, JUNIORBEES, ALPHA, MOALPHA50, MON100, MAFANG, MASPTOP50, MONQ50, MAHKTECH (SBISENSEX.BO missing data). Strong Setups: MONQ50, MIDCAPETF. Small/mid-cap ETFs dominate actionable setups; broad Nifty ETFs in Stage 4; gold/silver in Stage 3 topping. Watchlist updated.
- [2026-06-28 NSE Swing Trading Opportunity Scan](trade-journal/analysis/2026-06/2026-06-28-nse-swing-scan-analysis1.md) — NIFTYBEES, BANKBEES, MIDCAPETF, HDFCSML250, ICICIBANK, KOTAKBANK, LT, BAJAJHLDNG, GILLETTE, GLAXO, IRFC, ITC, UCOBANK, BANDHANBANK, APOLLOHOSP, EXIDEIND. Generated by reusable scanner `code/swing_analysis.py`; top mechanical setups: LT, BANDHANBANK, MIDCAPETF. Watchlist updated.
...
- [Market Structure](concepts/market-structure.md) - How orders, liquidity, participants, and venues shape price movement.
- [Market Leadership](concepts/market-leadership.md) - How leading groups emerge, confirm moves, and rotate.
- [Risk Management](concepts/risk-management.md) - Position sizing, drawdowns, exposure, stops, and portfolio-level risk.
...
- Pages marked `seed` are scaffolds awaiting source-backed development.
- Pages marked `needs-review` should be checked before relying on them.
- Pages marked `stale` require current verification before use.
